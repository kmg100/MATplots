...
class Testu_logs ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.image= Image.new('RGBA', (600,600))
        self.imgG = Image.new('RGBA', (600,600), color=(255,255,255,85))
        self.imgB = Image.new('RGBA', (600,600), color=(255,255,255,85))
        self.imgR = Image.new('RGBA', (600,600), color=(255,255,255,85))
        ...
        #self.imgB.paste(self.imgG)
        #self.imgB.paste(self.imgR)
