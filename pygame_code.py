...
class Testu_logs ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.imgR.save("imgR.png")
        self.imgG.save("imgG.png")
        self.imgB.save("imgB.png")
        pygame.init()
        #uzzime virsu viniem
        ...
        image1 = pygame.image.load("imgR.png").convert()
        image2 = pygame.image.load("imgG.png").convert()
        image3 = pygame.image.load("imgB.png").convert()
        ...
        self.wx_image1.SetData(image1.convert("RGB").tobytes())
        self.wx_image1.SetAlpha(image1.convert("RGBA").tobytes()[3::4])
        self.wx_image2.SetData(image2.convert("RGB").tobytes())
        self.wx_image2.SetAlpha(image2.convert("RGBA").tobytes()[3::4])
        self.wx_image3.SetData(image3.convert("RGB").tobytes())
        self.wx_image3.SetAlpha(image3.convert("RGBA").tobytes()[3::4])
